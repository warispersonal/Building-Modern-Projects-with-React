import {LOAD_TODO, LOAD_TODO_FAILURE, LOAD_TODO_SUCCESS, TODO_MARK_AS_COMPLETE} from "../action/todo_api";
const initialState = {
    loader: false,
    todos: [
        {
...
export const todoApiReducer = (state = initialState, action) =>{
    ...
    switch (type){
        ...
        case TODO_MARK_AS_COMPLETE: return {
            ...state,
            todos: state.todos.map(el=>(
                el.id===payload ? {...el, completed: true}: el
            ))
